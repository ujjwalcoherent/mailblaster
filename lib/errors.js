...
const CODES = {
  ...
  SEND_SUPPRESSED: {
    retry: 'never', http: 200,
    message: 'This person has replied, unsubscribed, or hard-bounced, and must not be emailed again.',
    hint: 'Blocked by the database regardless of which campaign this is — do_not_contact is on the person, not the campaign.',
  },
